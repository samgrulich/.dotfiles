...
export namespace Wp {
    ...
    class Client extends GlobalProxy implements PipewireObject {
        ...
        // Methods
        /**
         * Attaches a permission manager in the client to handle permissions automatically.
         * @param pm the permission manager to attach, or NULL to detach the current permission manager.
         */
        attach_permission_manager(pm: PermissionManager | null): void;

        /**
         * Gets the permission manager attached to this client, if any.
         * @returns the attached permission manager, or NULL if no permission manager is attached
         */
    ...
    class PermissionManager extends Object {
         ...
         * 
         * Interest consists of a GType that the object must be an ancestor of (g_type_is_a() must match) and optionally, a set of additional constraints on certain properties of the object. Refer to WpObjectInterest for more details.
         * @param callback the permissions match callback
         * @param interest the interest
         ...
         * 
         * Interest consists of a GType that the object must be an ancestor of (g_type_is_a() must match) and optionally, a set of additional constraints on certain properties of the object. Refer to WpObjectInterest for more details.
         * @param closure the closure to apply permissions
         * @param interest the interest
         * @returns the added match ID, or SPA_ID_INVALID if error
         */
    ...
    class SpaDevice extends Proxy {
        ...
        // Methods
        /**
         * This method can be used to retrieve object parameters of the spa device synchronously because the spa device always runs locally.
         * @param id the parameter id to enumerate
         * @param filter a param filter or NULL
         * @returns an iterator to iterate over cached parameters, or NULL if parameters for this `id` are not cached; the items in the iterator are WpSpaPod
         */
        ...
        /**
         * Sets a parameter on the spa device.
         * @param id the parameter id to set
         * @param flags optional flags or 0
         * @param param the parameter to set
         * @returns TRUE on success, FALSE if setting the param failed
    ...
    class Properties {
        ...
        /**
         * Clears all properties from `self`.
         */
        clear(): void;
