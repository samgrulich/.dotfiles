...
export namespace AyatanaAppIndicator3 {
    ...
    const INDICATOR_SIGNAL_ACTIVATE_EVENT: string;
    ...
    /**
     * String identifier for the {@link AyatanaAppIndicator3.Indicator.SignalSignatures.new_tooltip | AyatanaAppIndicator3.Indicator::new-tooltip} signal.
     */
    const INDICATOR_SIGNAL_NEW_TOOLTIP: string;
    ...
    namespace Indicator {
        ...
        interface SignalSignatures extends GObject.Object.SignalSignatures {
            /**
             * Signaled when the {@link AyatanaAppIndicator3.Indicator} receives a primary activation event
            ...
            /**
             * Emitted when {@link AyatanaAppIndicator3.Indicator.tooltip} is changed.
             * @signal
             * @since 0.6
             * @run-last
             */
            ...
            "notify::tooltip-body": (pspec: GObject.ParamSpec) => void;
    ...
    class Indicator extends GObject.Object {
         ...
         * @default null
         */
        get tooltip_body(): string;
        set tooltip_body(val: string);
        ...
        // Virtual methods
        /**
         * Slot for {@link AyatanaAppIndicator3.Indicator.SignalSignatures.activate | AyatanaAppIndicator3.Indicator::activate}
         * @param x 
         * @param y 
         * @virtual
         */
        vfunc_activate_event(x: number, y: number): void;
        ...
        /**
         * Slot for {@link AyatanaAppIndicator3.Indicator.SignalSignatures.new_tooltip | AyatanaAppIndicator3.Indicator::new-tooltip}.
         * @param user_data 
         * @virtual
         */
        vfunc_new_tooltip(user_data: null): void;
         ...
         * @returns The current tooltip text body.
         */
        get_tooltip_body(): string;
         ...
         * @returns The current tooltip icon name.
         */
        get_tooltip_icon(): string;
         ...
         * @returns The current tooltip title.
         */
        get_tooltip_title(): string;
         ...
         * @param body The text body shown in a tooltip.  Maps to AppIndicator:tooltip-body.
         */
        set_tooltip_body(body: string): void;

        /**
         * This is a wrapper function for the {@link AyatanaAppIndicator3.Indicator.tooltip_icon_name},
         * {@link AyatanaAppIndicator3.Indicator.tooltip_title} and {@link AyatanaAppIndicator3.Indicator.tooltip_body} properties.
         * @param icon_name The name of the icon shown in a tooltip.  Maps to AppIndicator:tooltip-icon-name.
         * @param title The title shown in a tooltip.  Maps to AppIndicator:tooltip-title.
         * @param body The text body shown in a tooltip.  Maps to AppIndicator:tooltip-body.
         */
        set_tooltip_full(icon_name: string, title: string, body: string): void;

        /**
         * Sets the icon which may be shown in the tooltip of the application indicator.
         * @param icon_name The name of the icon shown in the tooltip.  Maps to AppIndicator:tooltip-icon-name.
         */
        set_tooltip_icon(icon_name: string): void;

        /**
         * Sets the title part of a tooltip of the application indicator.
         * @param title The title shown in a tooltip.  Maps to AppIndicator:tooltip-title.
         */
        set_tooltip_title(title: string): void;
    }
