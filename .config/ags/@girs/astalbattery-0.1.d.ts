...
export namespace AstalBattery {
    ...
    class Device extends GObject.Object {
        ...
        // Properties
        /**
         * If it is {@link AstalBattery.Type.BATTERY}, you will need to verify that the property power-supply has the value `true` before 
         ...
         * This property is only valid if {@link AstalBattery.Device.device_type} is {@link AstalBattery.Type.LINE_POWER}.
         */
        get online(): boolean;
         ...
         * This property is only valid if {@link AstalBattery.Device.device_type} is {@link AstalBattery.Type.BATTERY}.
         */
        get energy(): number;
         ...
         * This property is only valid if {@link AstalBattery.Device.device_type} is {@link AstalBattery.Type.BATTERY}. The percentage 
         * will be an approximation if {@link AstalBattery.Device.battery_level} is set to something other than None.
         */
         ...
         * does not support coarse battery reporting, and the {@link AstalBattery.Device.percentage} should be used instead.
         */
         ...
         * NOTE: {@link AstalBattery.Device.battery_icon_name} might be a better fit as it is calculated from percentage.
         */
        ...
        /**
         * Indicates if {@link AstalBattery.Device.state} is charging or fully charged.
         */
        get charging(): boolean;
        set charging(val: boolean);

        /**
         * Indicates if {@link AstalBattery.Device.device_type} is not line power or unknown.
         */
        ...
        /**
         * A string representation of this device's {@link AstalBattery.Device.device_type}.
         */
        ...
        /**
         * An icon name that can be used to represent this device's {@link AstalBattery.Device.device_type}.
         */
    ...
    class UPower extends GObject.Object {
        ...
        // Signals
        /** @signal */
        connect<K extends keyof UPower.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, UPower.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof UPower.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, UPower.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof UPower.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<UPower.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;
