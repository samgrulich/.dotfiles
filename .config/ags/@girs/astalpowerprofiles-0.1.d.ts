...
export namespace AstalPowerProfiles {
    ...
    namespace PowerProfiles {
        ...
        interface SignalSignatures extends GObject.Object.SignalSignatures {
            /**
             * Emitted when the profile is released because {@link AstalPowerProfiles.PowerProfiles.active_profile} was manually changed. This will 
    ...
    class PowerProfiles extends GObject.Object {
        ...
        /**
         * Return a named icon based {@link AstalPowerProfiles.PowerProfiles.active_profile}.
         * @read-only
         */
        ...
        // Signals
        /** @signal */
        connect<K extends keyof PowerProfiles.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, PowerProfiles.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof PowerProfiles.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, PowerProfiles.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof PowerProfiles.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<PowerProfiles.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
         ...
         * quits, {@link AstalPowerProfiles.PowerProfiles.release_profile} is called, or the [property@
         ...
         * manually switches to another profile, and the `AstalPowerProfiles.PowerProfiles::profile_released` signal will be emitted.
         * @param profile 
         * @param reason 
