...
export namespace AstalHyprland {
    ...
    class Hyprland extends GObject.Object {
        ...
        // Signals
        /** @signal */
        connect<K extends keyof Hyprland.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, Hyprland.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof Hyprland.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, Hyprland.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof Hyprland.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<Hyprland.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;
         ...
         * @param _callback_ 
         */
        message_async(message: string, _callback_?: Gio.AsyncReadyCallback<this> | null): globalThis.Promise<string> | void;
    ...
    class Bind extends GObject.Object {
        ...
        // Signals
        /** @signal */
        connect<K extends keyof Bind.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, Bind.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof Bind.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, Bind.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof Bind.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<Bind.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
        emit(signal: string, ...args: any[]): void;
         ...
         * @param value 
         */
        set_modmask(value: bigint | number): void;
         ...
         * @param value 
         */
        set_keycode(value: bigint | number): void;
